 ...
 * Generated at: 2020-01-29 12:08:05 UTC
...
public final class debito_jsp extends org.apache.jasper.runtime.HttpJspBase
    ...
    try {
      ...
      out.write("\t");
		...
		if( (numConta != null) && (data != null) && (valor != null) && (descricao != null) ){
			...
			String parametros = "tipo=3&valores="+json.toString();
      ...
      out.write("\t\t<input type=\"text\" placeholder=\"Número da conta\" name=\"num_conta\" /><br>\r\n");
      out.write("\t\t<input type=\"text\" placeholder=\"Data\" name=\"data\" /><br>\r\n");
      out.write("\t\t<input type=\"text\" placeholder=\"Valor\" name=\"valor\" /><br>\r\n");
      out.write("\t\t<input type=\"text\" placeholder=\"Descrição\" name=\"descricao\" /><br>\t\r\n");
